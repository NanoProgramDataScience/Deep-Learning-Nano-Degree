...
# 
# __Answer:__ 
# 100% of human face were detected in the 'human files' and 11% of human face was detected in 'dog files'.
...
# 
# __Answer:__ 
# No It is not a reasonable expectation to pose on the user. We can use deep learning to train the features which will distinguish between human and dog even full face is not presented
# 
...
# __Answer:__ 
# 
# 0% of dog were detected in the 'human files' and 100% of dog was detected in 'dog files'.
...
# __Answer:__ 
# 
# I used the architecture which is suggested above, which is 3 convolution layers with poling layers. these layers helps to extract complex features. Then the following layer are flatten layer and dense fully connected layer. After all these, softmax layer is used to classify output into 133 categories.
...
num_classes = 133
# First Convolution Layer with patch size = 5, stride = 2, same padding an depth = 16 and Relu activation
...
# Second Convolution Layer with patch size = 5, stride = 2, same padding an depth = 32 and Relu activation
...
# Third Convolution Layer with patch size = 5, stride = 2, same padding an depth = 64 and Relu activation
...
# 
# __Answer:__ 
#  I tested both the Resnet and the Inception model and found the performance to be much better for the Resnet model. Once I selected the model, I followed the steps with the VGG16 model above. I added a global average pooling layer and a dense layer with Softmax activation to classify the output into one of 133 categories. With this architecture I was able to get 81% accuracy. I trained the model for 6 epochs. I found losses stabilized after 2-3 epochs .
...
# 
# __Answer:__ 
# The output of the model is pretty good. Better than I expected. On images it has never seen below, it was able to correctly identify most of dogs. However there is still scope for improvement.I have identified the following points for improvement:
# 
...
# 2. Can explore different models to reduce prodiction time while maintaining accuracy
# 3. Can use the ensemble learning to increase accuracy.
